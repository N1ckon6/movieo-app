...
const HorizontakScroll = ({ data = [], heading, trending, media_type }) => {
    ...
    <div className="container mx-auto px-3 my-10">
      ...
      <div className="relative">
        <div
          ...
          overflow-hidden overflow-x-scroll relative z-10 scroll-smooth transition-all
          scrollbar-none"
        >
          {data.map((data = [], index) => {
            return (
...
export default HorizontakScroll;
